                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_en">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">{{ $entity->title }}</div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Slug</label>
                                    <div class="col-md-9">{{ $entity->slug }}</div>
                                </div>
                            </div>
                            <!-- /.tab-pane -->
                            <div class="tab-pane" id="tab_es">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">{{ $translations['es']->title }}</div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-3">Slug</label>
                                    <div class="col-md-9">{{ $translations['es']->slug }}</div>
                                </div>
                            </div>
                            <!-- /.tab-pane -->
                        </div>
