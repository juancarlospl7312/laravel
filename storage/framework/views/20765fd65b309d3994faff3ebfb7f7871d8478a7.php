                ...
                <form data-action="<?php echo e(action('Backend\NewsController@update')); ?>" role="form" class="form-crud-edit" enctype="multipart/form-data">
                    ...
                    <?php echo e(csrf_field()); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" multiple="multiple" name="categories_many[]" id="categories_many" data-value="<?php echo e($entity->categories); ?>" required="required" style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" multiple="multiple" name="tags_many[]" id="tag_many" data-value="<?php echo e($entity->tags); ?>" required="required" style="width: 100%;">
