                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_es">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <?php $__currentLoopData = $category_translations['es']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <i><?php echo e($item); ?> <?php if(!$loop->last): ?>, <?php endif; ?></i>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div>
                                        <?php $__currentLoopData = $tag_translations['es']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <i><?php echo e($item); ?> <?php if(!$loop->last): ?>, <?php endif; ?></i>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
