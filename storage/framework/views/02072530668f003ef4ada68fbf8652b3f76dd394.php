    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form data-action="<?php echo e(action('Backend\CarouselController@add')); ?>" role="form"
...
<?php /**PATH D:\xampp\htdocs\workspace\laravel\resources\views/backend/carousel/create.blade.php ENDPATH**/ ?>