    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form data-action="<?php echo e(action('Backend\TagController@add')); ?>" role="form" class="form-crud-edit" enctype="multipart/form-data">
                    <div class="box-body">
...
<?php /**PATH D:\xampp\htdocs\workspace\laravel\resources\views/backend/tag/create.blade.php ENDPATH**/ ?>