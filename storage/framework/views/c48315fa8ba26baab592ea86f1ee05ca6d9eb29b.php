...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Tag | Edit</div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <form data-action="<?php echo e(action('Backend\TagController@update')); ?>" role="form" class="form-crud-edit" enctype="multipart/form-data">
                    <div class="box-body">
...
<?php /**PATH D:\xampp\htdocs\workspace\laravel\resources\views/backend/tag/edit.blade.php ENDPATH**/ ?>